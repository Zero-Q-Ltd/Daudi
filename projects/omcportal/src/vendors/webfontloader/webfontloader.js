  ...
  W.prototype.g = function (a) {
    ...
    b.g &&
      w(
        ...
        [
          b.a.c('wf', a.c, J(a).toString(), 'saving'),
  ...
  W.prototype.h = function (a) {
    ...
    if (b.g) {
      var c = y(b.f, b.a.c('wf', a.c, J(a).toString(), 'active')),
        d = [],
        e = [b.a.c('wf', a.c, J(a).toString(), 'saving')]
        ...
        ? ((a = a.a),
          a.g &&
            w(
              a.f,
              [a.a.c('wf', 'active')],
              [a.a.c('wf', 'saving'), a.a.c('wf', 'inactive')]
            ),
          K(a, 'active'))
        : L(a.a))
  }
        ...
        if (0 === c.length && f) L(b.a)
          ...
          for (h = 0; h < c.length; h++) {
            var k = c[h],
              ...
              r = b.a,
              x = k
            r.g && w(r.f, [r.a.c('wf', x.c, J(x).toString(), 'saving')])
            K(r, 'fontloading', x)
            r = null
            if (null === X)
              if (window.FontFace) {
