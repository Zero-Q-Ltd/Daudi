...
//         });
//       } else {
//         const alldepotdata = alldepots.docs.map(doc => doc.data() as Depot);
...
//                   const newDepot_: Depot = Object.assign(
//                     { ...emptydepot },
//                     item
//                   );
...
//  */
// function generatetaxconfig(depotdata: Depot, item: Item): taxconfig {
