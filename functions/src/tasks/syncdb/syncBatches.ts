...
import { Batch_ } from "../../models/Daudi/Batch";
import * as moment from "moment";
import { firestore } from "firebase-admin";
import { Depot_ } from "../../models/Daudi/Depot";
...
function covertbilltobatch(convertedBill: Bill, belongingdepot: Depot_ | undefined): Batch_ | null {
