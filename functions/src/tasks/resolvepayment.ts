...
export function resolveIpn(ipndetail: EquityBulk, ipnid: string): Promise<any> {
            ...
            .then(result => {
                ...
                return qbo
                    ...
                    .then(invoicesresult => {
                         ...
                         */
                        const allpendinginvoices: Array<QboOrder> =
                            invoicesresult.QueryResponse.QboOrder || [];
                        console.log(
                         ...
                         */
                        let invoicestotal = 0;
                        const applicableinvoices: Array<QboOrder> = [];
...
async function asyncForEach(array: any[] | QboOrder[], callback: any) {
